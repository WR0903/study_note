...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/wr/WHR/RGB-D/PART4/CODE/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/wr/WHR/RGB-D/PART4/CODE/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/wr/WHR/RGB-D/PART4/CODE/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/wr/WHR/RGB-D/PART4/CODE/data/depth2.png", -1 );
 ...
 //   string descriptor = pd.getData( "descriptor" );
  ...
  //  Eigen::Isometry3d TT = Eigen::Isometry3d::Identity();
    ...
    *output += *cloud2;
    pcl::io::savePCDFile("/home/wr/WHR/RGB-D/PART4/CODE/data/result.pcd", *output);
